...
PAGE: 67
SECTION: Wilderness
VERIFIED_TITLE: [If These Mountains Die]
VERIFIED_AUTHOR: John Treadwell Nichols
WORK_SCOPE: Abridged; Excerpt
EDITION_STATUS: Source identified; text not reproduced
TEXT_WITNESS: Opening page of If Mountains Die: A New Mexico Memoir (1979)
SOURCE: research/verification-log.md#wr-w-001---if-these-mountains-die
EDITION_NOTE: Identifies the extended protected opening-page passage and its apparent duplicated sentences. Replacement source text is not reproduced without a primary-page comparison and permission.
-->

## [If These Mountains Die]

*Extended opening-page passage from If Mountains Die; text not reproduced.*

*[Text omitted pending primary-source comparison and permission from the rights holder.]*
...
PAGE: 67
SECTION: Wilderness
VERIFIED_TITLE: [A Profound, a Fundamental Need for Areas of Wilderness]
VERIFIED_AUTHOR: Howard Zahniser
WORK_SCOPE: Abridged; Adapted; Composite; Excerpt
EDITION_STATUS: Source restored
TEXT_WITNESS: "The Need for Wilderness Areas," delivered in 1955 and published in The Living Wilderness, no. 59 (Winter-Spring 1956-1957)
SOURCE: research/verification-log.md#wr-w-002---we-have-a-profound-fundamental-need
EDITION_NOTE: Separates the two clauses that the booklet condensed into one sentence, restores Zahniser's repetition, and corrects the author note's "principle" to "principal."
-->

## [A Profound, a Fundamental Need for Areas of Wilderness]

*Two selected clauses from consecutive portions of "The Need for Wilderness Areas."*

We have a profound, a fundamental need for areas of wilderness. . . . This need is for areas of the earth within which we stand without our mechanisms that make us immediate masters over our environment.
...
PAGE: 67
SECTION: Wilderness
VERIFIED_TITLE: [So Rests the Sky Against the Earth]
VERIFIED_AUTHOR: Dag Hammarskjöld
WORK_SCOPE: Complete
EDITION_STATUS: Source identified; text not reproduced
TEXT_WITNESS: 1951 waymark in Markings (1964), translated by Leif Sjöberg and W. H. Auden
SOURCE: research/verification-log.md#wr-w-003---so-rests-the-sky-against-the-earth
EDITION_NOTE: Identifies the complete protected translation and documents the booklet's major corruptions, including "dark sill torn" for "dark still tarn." Replacement translation text is not reproduced.
-->

## [So Rests the Sky Against the Earth]

*Complete 1951 waymark in the Sjöberg-Auden translation; text not reproduced.*
...
PAGE: 67
SECTION: Wilderness
VERIFIED_TITLE: [There Is a Limit to the Number of Lands of Shoreline]
VERIFIED_AUTHOR: Arthur Hawthorne Carhart
WORK_SCOPE: Abridged; Excerpt
EDITION_STATUS: Source restored
TEXT_WITNESS: Memorandum for Aldo Leopold, District 3 (December 1919)
SOURCE: research/verification-log.md#wr-w-004---there-is-a-limit-to-the-number-of-lands-of-shoreline
EDITION_NOTE: Retains the confirmed phrase "lands of shoreline," restores "on the lakes" and plural "mountainous areas," and preserves both internal omissions.
-->

## [There Is a Limit to the Number of Lands of Shoreline]

*Selected passage from Carhart's December 1919 memorandum.*
